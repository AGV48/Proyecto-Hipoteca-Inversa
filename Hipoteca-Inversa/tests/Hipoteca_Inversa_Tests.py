...
class Hipoteca_Inversa_Test(unittest.TestCase):
    ...
    def testNegativo(self):
        ...
        edad_conyugue = 74
        sexo_conyugue = "mujer"
        self.assertRaises(Negative_Exception, Calcular_Hipoteca_Inversa.Logica_test, valor_inmueble, edad, estado_civil, edad_conyugue, sexo_conyugue, tasa_interes)
    ...
    def testCero_Hipoteca(self):
        ...
        edad_conyugue = 0
        sexo_conyugue = "nn"
        self.assertRaises(Hipoteca_Exception, Calcular_Hipoteca_Inversa.Logica_test, valor_inmueble, edad, estado_civil, edad_conyugue, sexo_conyugue, tasa_interes)
    ...
    def testEdad_Fuera_del_Rango(self):
        ...
        edad_conyugue = 55
        sexo_conyugue = "mujer"
        self.assertRaises(Edad_Minima_Exception, Calcular_Hipoteca_Inversa.Logica_test, valor_inmueble, edad, estado_civil, edad_conyugue, sexo_conyugue, tasa_interes)
    ...
    def testCero_Tasa(self):
        ...
        edad_conyugue = 74
        sexo_conyugue = "mujer"
        self.assertRaises(Tasa_Exception, Calcular_Hipoteca_Inversa.Logica_test, valor_inmueble, edad, estado_civil, edad_conyugue, sexo_conyugue, tasa_interes)
